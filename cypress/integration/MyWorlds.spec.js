...
const base = () => cy.visit('http://localhost:3000/MyWorlds');

describe('MyWorlds - layout load', () => {
...
describe('MyWorlds - layout functions', () => {
...
describe('MyWorlds - page functions', () => {
